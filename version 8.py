...
# ========================
# 10. Explore Lasso & Ridge with Multiple Alpha Values
# ========================
alphas = [0.1, 0.25, 0.5, 0.75, 1, 5, 10]
